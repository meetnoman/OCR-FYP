    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waitingDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialogInterface) {
               // getApplicationContext().startActivity(new Intent(getApplicationContext(),TextExtracted.class));
               // finish();
                testifier=false;
            }
        });
...
*/
        ...
        if (testifier) {
            ...
            String inputLanguage=LanguageRemindHelper.getInstance().getInputLanguage();
            if (uniqueRecognizedLanguage.contains(inputLanguage) || inputLanguage.equalsIgnoreCase("Detect Language")){
        ...
        Toast.makeText(getApplicationContext(),"Could not Detect for Specified Language",Toast.LENGTH_SHORT).show();
        }
